...
class Producto extends Model
{
    ...
    protected $fillable=['nombre', 'precio', 'descripcion', 'user_id', 'tipoProducto_id']; // Permite hacer la asignacion masiva

    protected $allowIncluded = ['posts', 'posts.user']; // Lista con las posibles relaciones que podemos enviar a travez de la URL

    protected $allowFilter = ['id', 'nombre', 'precio', 'descripcion', 'user_id', 'tipoProducto_id'];

    protected $allowSort = ['id','nombre', 'precio', 'descripcion', 'user_id', 'tipoProducto_id'];
